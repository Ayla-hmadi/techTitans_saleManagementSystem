...
export const vendorsGrid = [
  ...
  { field: "city", headerText: "City", width: "120", textAlign: "Center" },
  {
    field: "country",
    headerText: "Country",
    width: "120",
...
export const BranchesGrid = [
  ...
  { field: "Road", headerText: "Road", width: "150", textAlign: "Center" },
  {
    field: "phoneNumber",
    headerText: "Phone Number",
    width: "150",
...
export const ProductsData = [
  {
    ...
    vendorId: 1,
    name: "Product 1",
    Description: "This is product 1, it is a dummy product.",
  },
  {
    productId: 2,
    vendorId: 2,
    name: "Product 2",
    Description: "This is product 2, it is a dummy product.",
  },
  {
    productId: 3,
    vendorId: 3,
    name: "Product 3",
    Description: "This is product 3, it is a dummy product.",
  },
  {
    productId: 4,
    vendorId: 4,
    name: "Product 4",
    Description: "This is product 4, it is a dummy product.",
  },
  {
    productId: 5,
    vendorId: 5,
    name: "Product 5",
    Description: "This is product 5, it is a dummy product.",
  },
  {
    productId: 6,
    vendorId: 6,
    name: "Product 6",
    Description: "This is product 6, it is a dummy product.",
  },
  {
    productId: 7,
    vendorId: 7,
    name: "Product 7",
    Description: "This is product 7, it is a dummy product.",
  },
  {
    productId: 8,
    vendorId: 8,
    name: "Product 8",
    Description: "This is product 8, it is a dummy product.",
  },
  {
    productId: 9,
    vendorId: 9,
    name: "Product 9",
    Description: "This is product 9, it is a dummy product.",
  },
  {
    productId: 10,
    vendorId: 10,
    name: "Product 10",
    Description: "This is product 10, it is a dummy product.",
  },
];
...
export const ordersData = [
  {
    ...
    invoiceId: "1",
    customerId: 123,
    expectedDeliveryDate: "2023-04-22",
  },
  {
    orderId: 2,
    invoiceId: "2",
    customerId: 456,
    expectedDeliveryDate: "2023-04-25",
  },
  {
    orderId: 3,
    invoiceId: "3",
    customerId: 789,
    expectedDeliveryDate: "2023-04-28",
  },
];
